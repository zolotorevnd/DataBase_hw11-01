...
База данных способная горизонтально масштабироваться, обеспечивающая надежность, администрирование пользователей, гибкую настройку, надежную работу, логирование и сохранность данных, репликацию. Для всех этих запросов подойдет реляционная база данных.